    ...
    var rawHTML = ' '+
        ...
        '<html lang="en">'+
            '<head>'+
                ...
                '<link rel="preload" href="'+cpath+'all.css" as="style" crossorigin="anonymous" referrerpolicy="no-referrer" />'+
                '<link rel="stylesheet" href="'+cpath+'all.css" data-n-g="" crossorigin="anonymous" referrerpolicy="no-referrer" />'+
