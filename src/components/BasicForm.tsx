...
type FormObjs = FormObj[];



import { PhotoIcon, UserCircleIcon } from '@heroicons/react/24/solid';

export default function BasicForm({ titleH = '', descriptionH = '', formElements={}, formButton = '', formDeleteT = '', formInline = false, formBack = false, toggleButton = false }) {
        ...
        <div className='flex flex-col gap-28'>
            <form className='w-full flex flex-col justify-center'>
                <div className="space-y-12">
                    <div className="pb-12">
                        {titleH && <h2 className="text-base font-semibold leading-7 text-gray-900">{titleH}</h2>}
                        {descriptionH && <p className="mt-1 leading-6 text-gray-600">
                            This information will be displayed publicly so be careful what you share.
                        </p>}

                        <div className="mt-10 flex flex-col gap-4">
                            {Object.keys(formElements).map((keyName, i, textI) => {
                                                ...
                                                <div key={formElements[keyName].textI} className={`${formInline ? 'flex items-center gap-4':''}`}>
                                                    ...
                                                    <div className="mt-1">
                                                        <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                                            {formElements[keyName].prev && <span className="flex select-none items-center pl-3 text-gray-400 sm:text-sm">workcation.com/</span>}
                                                            <input
                                                                type={formElements[keyName].inputT}
                                                                name={formElements[keyName].textI.replaceAll(' ', '-')}
                                                                id={formElements[keyName].textI.replaceAll(' ', '-')}
                                                                autoComplete={formElements[keyName].inputT}
                                                                ...
                                                                placeholder={formElements[keyName].placeH ? formElements[keyName].placeH : formElements[keyName].textI}
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div key={formElements[keyName].textI} className="">
                                                    ...
                                                    <div className="mt-2">
                                                        <textarea
                                                            id={formElements[keyName].textI.replaceAll(' ', '-')}
                                                            name={formElements[keyName].textI.replaceAll(' ', '-')}
                                                            rows={formElements[keyName].rows? formElements[keyName].rows:3}
                                                    ...
                                                    <div className="containerExpandible">
                                                        <div className="text-center mt-2 flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                                            <div className="mt-4 flex leading-6 text-gray-600">
                                                                <label
                                                                    htmlFor={formElements[keyName].textI.replaceAll(' ', '-')}
                                                                ...
                                                                >
                                                                    ...
                                                                    <input id={formElements[keyName].textI.replaceAll(' ', '-')} name={formElements[keyName].textI.replace(' ', '-')} type="file" className="sr-only" />
                                                                </label>
